...
glm::vec4 vertGreenPanel[] = { // 2 * 3 = 6 (vertices + color)
	// face 0: v0-v1-v2, green, CCW
	{ -0.3F, -0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v0
	{ +0.3F, -0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v1
	{ -0.3F, +0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v2
	// face 1: v2-v1-v3, green, CCW
	{ -0.3F, +0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v2
	{ +0.3F, -0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v1
	{ +0.3F, +0.3F, 0.7F, 1.0F }, { 0.3F, 1.0F, 0.3F, 1.0F, }, // v3
};
glm::vec4 vertRedHole[] = { // 2 * 3 = 6 (vertices + color)
	// face 0: v0-v2-v1, green, CW
	{ -0.1F, -0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v0
	{ -0.1F, +0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v2
	{ +0.1F, -0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v1
	// face 1: v1-v2-v3, green, CW
	{ +0.1F, -0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v1
	{ -0.1F, +0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v2
	{ +0.1F, +0.1F, 0.7F, 1.0F }, { 1.0F, 0.3F, 0.3F, 1.0F, }, // v3
};
glm::vec4 vertYellowPanel[] = { // 2 * 3 = 6 (vertices + color)
	// face 0: v0-v1-v2, yellow, CCW
	{ -0.5F, -0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v0
	{ +0.5F, -0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v1
	{ -0.5F, +0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v2
	// face 1: v2-v1-v3, yellow, CCW
	{ -0.5F, +0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v2
	{ +0.5F, -0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v1
	{ +0.5F, +0.4F, 0.7F, 1.0F }, { 0.6F, 0.6F, 0.3F, 1.0F, }, // v3
};
...
void drawFunc(void) {
	...
	// STENCIL WRITE: draw the green panel with a red hole
	glColorMask(false, false, false, false);
	glDepthMask(false);
	glDisable(GL_DEPTH_TEST); // avoid z-fighting
	glFrontFace(GL_CCW);
	glDisable(GL_CULL_FACE); // to output back-faces as well
	glEnable(GL_STENCIL_TEST);
	glStencilMask(0xFF);
	glStencilFunc(GL_ALWAYS, 0x01, 0xFF);
	glStencilOpSeparate(GL_FRONT, GL_KEEP, GL_KEEP, GL_INCR_WRAP);
	glStencilOpSeparate(GL_BACK, GL_KEEP, GL_KEEP, GL_DECR_WRAP);
	glVertexAttribPointer(locPos, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertGreenPanel[0]));
	glVertexAttribPointer(locColor, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertGreenPanel[1]));
	glUniformMatrix4fv(locModel, 1, GL_FALSE, glm::value_ptr(matPanel));
	glDrawArrays(GL_TRIANGLES, 0, 6); // 6 vertices
	glVertexAttribPointer(locPos, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertRedHole[0]));
	glVertexAttribPointer(locColor, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertRedHole[1]));
	glUniformMatrix4fv(locModel, 1, GL_FALSE, glm::value_ptr(matPanel));
	glDrawArrays(GL_TRIANGLES, 0, 6); // 6 vertices
	// STENCIL USE: draw objects with stencil pass
	glEnable(GL_DEPTH_TEST);
	glFrontFace(GL_CCW);
	glCullFace(GL_BACK);
	glEnable(GL_CULL_FACE);
	...
	glEnable(GL_STENCIL_TEST);
	glStencilMask(0xFF);
	glStencilFunc(GL_LESS, 0x00, 0xFF); // if (0 < stencil value), it passed
	glStencilOp(GL_KEEP, GL_KEEP, GL_KEEP);
	// normal draw
	drawObjects(locPos, locColor, locModel);
	// draw yellow panel
	glStencilFunc(GL_EQUAL, 0x00, 0xFF); // if (0 == stencil value), it passed
	glStencilOp(GL_KEEP, GL_KEEP, GL_KEEP);
	glVertexAttribPointer(locPos, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertYellowPanel[0]));
	glVertexAttribPointer(locColor, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), glm::value_ptr(vertYellowPanel[1]));
	glUniformMatrix4fv(locModel, 1, GL_FALSE, glm::value_ptr(matPanel));
	glDrawArrays(GL_TRIANGLES, 0, 6); // 6 vertices
	// stencil buffer off
