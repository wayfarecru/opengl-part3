...
const char* vertFileName = "c82-colored-tri.vert";
const char* fragFileName = "c82-colored-tri.frag";
...
int main(int argc, char* argv[]) {
	...
	// start GLFW & GLEW
	glfwInit();
	glfwWindowHint(GLFW_SAMPLES, 4); // 4x MSAA applied
