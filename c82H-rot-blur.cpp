...
const char* vertFileName = "c82-rotate.vert";
const char* fragFileName = "c82-rotate.frag";
...
const float epsilon = 0.5F * (2.0F * (float)M_PI / 360.0F); // 0.5 degree
...
void drawFunc(void) {
	...
	// draw the triangle, with motion blur
	glEnable(GL_BLEND);
	...
	for (unsigned i = 0; i < 8; ++i) {
		...
		glUniform1f(locTheta, theta - i * epsilon);
