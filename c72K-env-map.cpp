...
const char* vertFileName = "c72-env-map.vert";
const char* fragFileName = "c72-env-map.frag";
...
#include "c72-room-map-0.cpp"
#include "c72-room-map-1.cpp"
#include "c72-room-map-2.cpp"
#include "c72-room-map-3.cpp"
#include "c72-room-map-4.cpp"
#include "c72-room-map-5.cpp"
...
void initTex(void) {
	...
	if (glewIsSupported("GL_VERSION_4_5") && (use_new_tex_syntax == true)) {
		...
		glTextureStorage2D(texObj, 1, GL_RGBA8, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT);
		glTextureSubImage3D(texObj, 0, 0, 0, 0, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_0);
		glTextureSubImage3D(texObj, 0, 0, 0, 1, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_1);
		glTextureSubImage3D(texObj, 0, 0, 0, 2, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_2);
		glTextureSubImage3D(texObj, 0, 0, 0, 3, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_3);
		glTextureSubImage3D(texObj, 0, 0, 0, 4, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_4);
		glTextureSubImage3D(texObj, 0, 0, 0, 5, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 1,
		                    GL_RGBA, GL_UNSIGNED_BYTE, room_map_5);
		...
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_0);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 1, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_1);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 2, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_2);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 3, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_3);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 4, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_4);
		glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 5, 0, GL_RGBA, ROOM_MAP_0_WIDTH, ROOM_MAP_0_HEIGHT, 0,
		             GL_RGBA, GL_UNSIGNED_BYTE, room_map_5);
...
void drawFunc(void) {
	...
	matAccum = glm::scale( matAccum, glm::vec3(0.6F, 0.8F, 0.6F));
